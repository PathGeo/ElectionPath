...
rangeSelector.prototype.initInteraction_ = function() {
  ...
  toXDataWindow = function(zoomHandleStatus) {
    ...
    var fact = (xDataLimits[1] - xDataLimits[0])/self.canvasRect_.w;
     xDataMin = xDataLimits[0] + (zoomHandleStatus.leftHandlePos - self.canvasRect_.x)*fact;
     xDataMax = xDataLimits[0] + (zoomHandleStatus.rightHandlePos - self.canvasRect_.x)*fact;
  ...
  onZoomEnd = function(e) {
    ...
    //alert( 'onZoomEnd -> From Date: ' + fromDate + '    To Date: ' + toDate ); 
  ...
  //alert( 'onPanEnd ->> From Date: ' + fromDate + '    To Date: ' + toDate );   
...
rangeSelector.prototype.getZoomHandleStatus_ = function() {
  var halfHandleWidth = this.leftZoomHandle_.width/2;
   leftHandlePos = parseFloat(this.leftZoomHandle_.style.left) + halfHandleWidth;
   rightHandlePos = parseFloat(this.rightZoomHandle_.style.left) + halfHandleWidth;
  return {
